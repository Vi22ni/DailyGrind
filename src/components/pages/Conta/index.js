...
const Conta = ({navigation}) => {
  ...
  const deleteUsuario = async () => {
    ...
    try{
      await fetch('http://localhost:3000/usuario/' + UsuarioLogado[0].idusuario, requestOptions)
      navigation.navigate('Login')
      logOut();
    } catch(error){
      console.log("Erro: " + error)
  ...
  React.useEffect(() => {
    ...
    return(
        ...
        <Modal visible={modalAberto3} transparent={true} animationType='fade' >
                    <View style={styles.containerModal3}>
                        ...
                        <View style={styles.viewbtnFechar}>
                            ...
                            <TouchableOpacity style={styles.btnFechar} onPress={() => setModalAberto3(false)}>
                            <Ionicons name="close" size={30} color ='#B8B8B8'/>  
                            </TouchableOpacity>
                        </View>
                        
                         <View style={styles.viewText}><Text style={styles.textExcluir}>Você deseja excluir a conta?</Text></View>
                         </View>
                        <View style={styles.posicionarView}>
                        <View style={styles.viewFantasma}></View>
                            <View style={styles.viewBtnModal}>
                                <TouchableOpacity style={styles.btnExitModal3} onPress={() => deleteUsuario()}>
                ...
                <View style={styles.viewInputs}>
                    ...
                    <TouchableOpacity style={styles.dadosContaBoxDelete}>
                            <Text style={styles.btnDeletar} onPress={() => setModalAberto3(true)}>Deletar</Text>
                    </TouchableOpacity>
